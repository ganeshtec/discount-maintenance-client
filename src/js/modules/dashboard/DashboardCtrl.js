app.controller('DashboardCtrl', ['$filter','$scope', 'DataFactory', 'promotionDataService','$location','$routeParams','$mdDialog', 'dashboardDataService','OverlayConfigFactory',
	function ($filter,$scope,DataFactory,promotionDataService,$location,routeParams,$mdDialog,dashboardDataService,OverlayConfigFactory) {
		...
		$scope.setupSortableHeader = function(){
			$scope.headers = [
				{ "sortId":"promoId","text":"Id","width":"3%"},
				{ "sortId":"name","text":"Promotion Name","width":"25%"},
				{ "sortId":"statusName","text":"Status","width":"5%"},
				{ "sortId":"promoSubTypeDesc","text":"Promotion Type","width":"8%"},
				{ "sortId":"startDate","text":"Start Date","width":"5%"},
				{ "sortId":"endDate","text":"End Date","width":"5%"},
				{ "sortId":"createdBy","text":"Created By","width":"5%"},
				{ "sortId":"lastModifiedBy","text":"Last Modified (ID/Date)","width":"12%"},
				{ "sortId":"priority","text":"Priority","width":"4%"}
			];
		}
