...
app.directive('promotionPreview', ["URL_CONFIG","promotionDataService","OverlayConfigFactory","DataFactory","utilService",function(URL_CONFIG,promotionDataService,overlayConfig,DataFactory,utilService){
	return {
		restrict : 'E',
		...
		link : function (scope, element, attrs) {
			...
			scope.saveAndSubmit = function(event){				
				...
				var clickableSaveBtn = function(event){
					event.handleObj.handler = function(){scope.saveAndSubmit(event);}
				}
