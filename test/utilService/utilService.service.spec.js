describe('utilService', function () {
    ...
    it('returns error message from validateBuyAandBOverlap (value) for multi item promotions with overlapping categories (hierarchies).', function () {
        var promotion = {
            "promoId": 18116,
            "promoSubTypeCd": "MultipleItemsValueDiscount",
            "status": 61,
            "purchaseConds": {
                "sources": [{
                    "inclusions": {
                        ...
                        "itemtype": null,
                        "hierarchies": [{
                            "id": "da80fc04-3857-427c-ada9-8b868b6bb45c",
                            "name": "Pipes & Fittings",
                            "catalog": "Web"
                        }]
                    }
            ...
            "purchaseConds": {
                "sources": [{
                    "inclusions": {
                        ...
                        "itemtype": null,
                        "hierarchies": [{
                            "id": "da80fc04-3857-427c-ada9-ffffffffffff",
                            "name": "Pipes & Fittings",
                            "catalog": "Web"
                        }]
                    }
    ...
    it('returns error message from validateBuyAandBOverlap (value) for multi item promotions with overlapping products (part numbers).', function () {
        var promotion = {
            ...
            "purchaseConds": {
                "sources": [{
                    "inclusions": {
                        "partnumbers": [100169919],
                        "itemtype": null,
                        "hierarchies": []
                    }
                }, {"inclusions": {"partnumbers": [100169919], "itemtype": null, "hierarchies": []}}]
            }
        };
    ...
    it('returns null from validateBuyAandBOverlap (value) for multi item promotions with non overlapping products (part numbers).', function () {
        var promotion = {
            ...
            "purchaseConds": {
                ...
                }, {"inclusions": {"partnumbers": [100351464], "itemtype": null, "hierarchies": []}}]
            }
        };
            ...
            "purchaseConds": {
                "sources": [{
                    ...
                    "inclusions": {
                        "partnumbers": [100169919],
                        "itemtype": null,
                        "hierarchies": [{"id": "2>>2", "name": "SPC TESTS>>SPC CLASS", "catalog": "Merch"}]
                    }
                }]
            }
        };
